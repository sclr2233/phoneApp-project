<template>
	<view class='home'>
		<view class='courseIntroduce-box'>
			...
			<view class='courseIntroduce-tab-box'>
				<view class='courseIntroduce-tab-nav'>
			...
			<view class='courseIntroduce-tab-con'>
			    <view class='discount-info' :class='{dis:count===0}'>
					<CourseList :videoList="Colist" />
				</view>
				<view class='discount-info' :class='{dis:count===1}'>
